...
class MainGuy(pygame.sprite.Sprite): # Настройки персонажа
    def __init__(self, screen):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("norm.bmp")
    ...
    def slide(self):
        self.image = pygame.image.load("down.bmp")
        self.image = self.image.convert_alpha()
...
class Obstacle(pygame.sprite.Sprite): # Настройки препятствий
    def __init__(self, screen):
        color = black
        pygame.sprite.Sprite.__init__(self)
